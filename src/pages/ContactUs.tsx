...
const ContactUs = () => {
  ...
  return (
    <div className="bg-background">
      {/* Hero Banner */}
      <section className="relative mx-2 md:mx-4 min-h-[420px] md:h-[520px] rounded-2xl md:rounded-[14px] overflow-hidden">
        <img
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-center min-h-[420px] md:h-full md:px-18 px-4 py-10 md:py-0 text-primary-foreground">
          <div className="w-full md:w-1/2 text-center md:text-right md:pr-6">
            ...
            <h1 className="text-2xl md:text-5xl font-extrabold leading-tight">Contact Aarvak Diagnostics</h1>
            <p className="text-sm md:text-base opacity-90 mt-1">Book a Test Today</p>
          </div>
