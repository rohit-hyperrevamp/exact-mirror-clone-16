        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-gray-600">
              ...
              <p>
                ...
                <a href="tel:+919266333711" className="hover:text-gray-900">+91 92663 33711</a>
                {" / "}
                <a href="tel:+919810063340" className="hover:text-gray-900">+91 9810063340</a>
              </p>
              <p>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/919266333711" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-gray-700 transition">
